...
public class ServerSocket {
    ...
    private static void receiveAndSendTimeout() {
        try (var serverSocket = new java.net.ServerSocket(Common.SERVER_PORT)) {
            serverSocket.setSoTimeout(Common.CONNECT_TIMEOUT);
